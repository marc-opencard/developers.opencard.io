...
<Warning>
  This is **not** the EMS API (`api.opencard.io`) and **not** the receipt provider callback. This is for **issuers** who want to offer digital receipts to their cardholders.
</Warning>
