...
|------|-----------|---------|
| **Cards** | `GET/POST/PUT/DELETE .../cards` | Register and maintain cards |
| **Transaction states** | `POST .../cards/{card_id}/transaction_states` | Deliver transaction lifecycle events |
