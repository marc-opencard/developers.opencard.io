...
description: XML and JSON receipt payloads for receipt provider callbacks.
---

When you POST to OpenCard's callback endpoint, the body format depends on the callback type configured for the request.
...
EMS integrators receive these automatically — you don't call the EMS.
