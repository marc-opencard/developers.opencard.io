...
description: POST receipt data back to OpenCard. Headers, signature, payload.
---

```
POST /api/v1/service/marcet/callback/{referenceId}
```

`{referenceId}` = OpenCard transaction reference.
