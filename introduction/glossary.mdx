...
| **Payment product** | The card a client activates (debit or credit under a payment program). Enable products on your account, then pass the product `id` as `payment_product_id` on the TPA. |
