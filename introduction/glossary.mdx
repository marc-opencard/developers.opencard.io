...
| **Receipt Provider** | Collects receipts from merchants and delivers them to OpenCard. OpenCard forwards enriched data to EMS. |
...
| **Assently CoreID** | eID provider widget for Nordic signing. |
