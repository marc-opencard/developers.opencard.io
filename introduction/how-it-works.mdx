...
**Billing** = invoice grouping for **your** OpenCard bill. One billing profile can cover one or many organizations. Example: three orgs share `billing_id: 1` → one combined invoice from OpenCard to your finance team. → [Billing](/ems/billing)
...
→ [Parallel transaction feeds](/ems/card-holders#when-the-client-already-has-another-transaction-feed)
