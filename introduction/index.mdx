...
| 💳 **Card issuer / bank** | [Card Issuers](/card-issuers) | Fetch digital receipts for cardholders via `receipts.opencard.io`. |
| 🧾 **Receipt provider** | [Receipt Providers](/receipt-providers) | Collect receipts, deliver to OpenCard for EMS enrichment. |
