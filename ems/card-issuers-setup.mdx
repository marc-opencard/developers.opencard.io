---
title: Card issuer setup
description: One-time setup — discover card programs on OpenCard, enable them on your account, and expose them in your client marketplace before TPA onboarding.
---
