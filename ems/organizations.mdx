---
title: Organizations
description: Create and manage organizations in OpenCard — the container for your EMS end-clients that holds webhooks, card holders, and TPA links via reference_id.
---
