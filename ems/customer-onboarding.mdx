...
| Guide | When |
|-------|------|
| [Card issuers (EMS setup)](/ems/card-issuers-setup) | Once per EMS account — enable programs before any client onboards |
...
→ [Card issuers (EMS setup)](/ems/card-issuers-setup) · [TPA flow](/ems/tpa-flow) · [Billing](/ems/model/billing) · [Webhooks](/ems/webhooks/setup)
...
|---|------|--------------|--------------|
| 0 | Enable card issuer(s) on account (once) | `GET /cardissuers` → `POST .../accounts/{id}/cardissuers/{id}` (or [application.opencard.io](https://application.opencard.io)) | [Card issuers setup](/ems/card-issuers-setup) |
| 1 | Client picks card program | `GET .../accounts/{id}/cardissuers` → `card_issuer_id` on TPA | [Card issuers setup](/ems/card-issuers-setup) |
...
| Page | What it covers |
|------|----------------|
| [Card issuers (EMS setup)](/ems/card-issuers-setup) | Enable programs, marketplace UI, `card_issuer_id` |
