...
| 1 | Client picks payment product | `GET .../accounts/{id}/payment-products` → `card_issuer_id` on TPA | [Payment product setup](/ems/payment-products-setup) |
...
| Page | What it covers |
|------|----------------|
| [Payment product setup](/ems/payment-products-setup) | Enable products, marketplace UI, `card_issuer_id` |
