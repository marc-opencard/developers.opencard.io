---
title: Webhook Setup
description: Create an OpenCard webhook, complete the verification challenge, configure authentication headers, and route events per organization for your EMS integration.
---
