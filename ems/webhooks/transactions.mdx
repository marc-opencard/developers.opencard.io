...
If `true`, a digital receipt exists for this transaction at one of OpenCard's Receipt provider partners — expect `receipt.fetched` (and often TrueVAT / line items) shortly after. If `false`, don't wait for a digital receipt.
