...
5. **`card_issuer_reference` differs per state** — don't use it as your primary key; when merging with another feed, compare cleared-to-cleared only → [parallel feeds](/ems/card-holders#when-the-client-already-has-another-transaction-feed)

---

## Parallel transaction feeds
...
Full guidance → [Card holder onboarding — parallel feeds](/ems/card-holders#when-the-client-already-has-another-transaction-feed)
