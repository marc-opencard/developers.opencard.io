...
description: Integrate OpenCard when a client already receives transactions from another issuer feed — disable sources, replay retroactively, deduplicate cleared events.
---
