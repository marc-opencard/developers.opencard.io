...
description: Integrate OpenCard when a client already gets card transactions from another issuer feed — disabling sources, retroactive replay, deduplicating cleared events.
---
