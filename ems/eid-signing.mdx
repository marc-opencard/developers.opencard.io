...
description: How OpenCard handles TPA and PDPC eID signing via Assently CoreID — sign and auth modes, BankID, MitID, and providers in Sweden, Norway, Denmark, Finland.
---
