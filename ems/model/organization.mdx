---
title: Organization
description: The Organization model — your EMS end-client in OpenCard, the runtime container for webhooks, card holders, event routing, and TPA legal linkage.
---
