---
title: Card holder
description: The Card holder model — an individual inside an organization whose card transactions OpenCard identifies, links to an identity, and streams to your EMS.
---
