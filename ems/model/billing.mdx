...
<Note>
  Create billing during [client setup](/ems/customer-onboarding#step-by-step), together with the TPA. An optional [ocTPA plugin](/ems/plugins) collects the same fields — you still POST this API.
</Note>
