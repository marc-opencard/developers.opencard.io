...
6. Picks eID provider (BankID/MitID/etc — see [eID Signing](/ems/eid-signing))
7. Completes eID
...
<Tip>
  Switch from legacy issuer integration to OpenCard when you receive `card_holder.identified` — that's when OpenCard starts delivering historical transactions since last invoice.
</Tip>
