...
description: Integrate OpenCard when your client already receives card transactions from another issuer feed — who disables what, retroactive replay, and deduplicating cleared events.
---
