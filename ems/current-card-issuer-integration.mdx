...
description: Integrate OpenCard when a client already has another card issuer feed — who disables what, retroactive replay, and deduplicating cleared transaction events.
---
...
4. To end the old feed, your **client** terminates it with their **card issuer**. Agree with your client when to stop processing the other integration on your side — you do not need to wait for that before accepting OpenCard data.
