...
description: End-to-end OpenCard EMS quickstart — register a sandbox account, sign a TPA, create an organization, onboard a card holder, and receive your first webhook.
---
...
curl -X POST https://sandbox-api.opencard.io/oauth/token \
  ...
  -d "scope=account-tpas-write account-tpas-read account-tpa-signatories-write organizations-write organizations-read card-holders-write webhooks-write webhooks-read public-records-read payment-products-read account-payment-products-read account-payment-products-write"
```
...
## Step 2: Enable a payment product
